...
function bhv_star_loop(o)
    if obj_has_model_extended(o, E_MODEL_TRANSPARENT_STAR) == 0 then
        ...
        if gNetworkPlayers[0].currLevelNum == LEVEL_BBH and gNetworkPlayers[0].currAreaIndex == 1 or gNetworkPlayers[0].currLevelNum == LEVEL_SSL and gNetworkPlayers[0].currAreaIndex == 1 or gNetworkPlayers[0].currLevelNum == LEVEL_HMC and gNetworkPlayers[0].currAreaIndex == 1 or gNetworkPlayers[0].currLevelNum == LEVEL_LLL then
        ...
        if gNetworkPlayers[0].currLevelNum == LEVEL_WMOTR or gNetworkPlayers[0].currLevelNum == LEVEL_BITFS or gNetworkPlayers[0].currLevelNum == LEVEL_SA and gNetworkPlayers[0].currAreaIndex == 1 then
            obj_set_model_extended(o, E_MODEL_STAR_W8)
        end
    end
end
