...
AREA(1,Geo_totwc_1_0x254bc90),
TERRAIN(col_totwc_1_0xe011870),
...
OBJECT_WITH_ACTS(221,-246,130,49,0,270,0,0xc000001, bhvKingBobomb,31),
...
WARP_NODE(10,26,2,1,0),
WARP_NODE(240,6,1,50,0),
WARP_NODE(241,6,1,100,0),
RETURN()
};
const LevelScript local_area_totwc_2_[] = {
AREA(2,Geo_totwc_2_0x254be70),
TERRAIN(col_totwc_2_0xe012070),
SET_BACKGROUND_MUSIC(0,59),
TERRAIN_TYPE(0),
...
OBJECT_WITH_ACTS(0,-1638,0,98,0,90,0,0xa0000, bhvSpinAirborneWarp,31),
OBJECT_WITH_ACTS(221,-246,130,49,0,270,0,0x10000203, bhvKingBobomb,31),
OBJECT_WITH_ACTS(0,-2142,0,62,0,90,0,0xa0a0000, bhvWarp,31),
//OBJECT_WITH_ACTS(0,0,0,0,0,0,0,0x0,0x0041f5a0,31),
RETURN()
};
const LevelScript local_warps_totwc_2_[] = {
WARP_NODE(10,16,3,1,0),
WARP_NODE(240,6,1,50,0),
WARP_NODE(241,6,1,100,0),
RETURN()
};
const LevelScript local_area_totwc_3_[] = {
AREA(3,Geo_totwc_3_0x254c050),
TERRAIN(col_totwc_3_0xe010050),
SET_BACKGROUND_MUSIC(0,59),
TERRAIN_TYPE(0),
...
OBJECT_WITH_ACTS(0,-1638,0,98,0,90,0,0xa0000, bhvSpinAirborneWarp,31),
OBJECT_WITH_ACTS(221,-246,130,49,0,270,0,0x14000405, bhvKingBobomb,31),
OBJECT_WITH_ACTS(0,-2142,0,62,0,90,0,0xa0a0000, bhvWarp,31),
//OBJECT_WITH_ACTS(0,0,0,0,0,0,0,0x0,0x0041f5a0,31),
RETURN()
};
const LevelScript local_warps_totwc_3_[] = {
WARP_NODE(10,26,3,1,0),
WARP_NODE(240,6,1,50,0),
WARP_NODE(241,6,1,100,0),
RETURN()
};
