...
const GeoLayout Geo_wmotr_1_0x2043ff0[]= {
...
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
GEO_CAMERA_FRUSTUM_WITH_FUNC(45,100,50480, geo_camera_fov),
GEO_OPEN_NODE(),
GEO_CAMERA(1,0,2000,6000,3072,0,60928, geo_camera_main),
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_wmotr_1_0xe075130),
GEO_DISPLAY_LIST(4,DL_wmotr_1_0xe085dd0),
GEO_DISPLAY_LIST(5,DL_wmotr_1_0xe086578),
GEO_RENDER_OBJ(),
