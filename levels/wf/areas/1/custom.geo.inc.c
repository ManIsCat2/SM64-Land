...
const GeoLayout Geo_wf_1_0x1430ea0[]= {
...
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
GEO_CAMERA_FRUSTUM_WITH_FUNC(45,100,46384, geo_camera_fov),
GEO_OPEN_NODE(),
GEO_CAMERA(1,0,2000,6000,3072,0,60928, geo_camera_main),
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_wf_1_0xe0510f0),
GEO_DISPLAY_LIST(6,DL_wf_1_0xe05c210),
GEO_DISPLAY_LIST(6,DL_wf_1_0xe05c3f8),
GEO_RENDER_OBJ(),
