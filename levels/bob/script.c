...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		WARP_NODE(0xF0, 16, 1, 21, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, 16, 1, 31, WARP_NO_CHECKPOINT),
		MARIO_POS(0x01, 0, -1674, 773, 12523),
		...
		OBJECT(E_MODEL_BOB_SEESAW_PLATFORM, 1254, 5506, 5948, 0, 90, 0,0x000300000, id_bhvSeesawPlatform),
		...
		/* no acts lol OBJECT(E_MODEL_NONE, 948,4677,7704, 0, 90, 0, 0, id_bhvGoombaTripletSpawner),*/
		...
		/* no acts lol OBJECT(E_MODEL_NONE, 23073,3126,10185, 0, 0, 0, 0, id_bhvGoombaTripletSpawner),*/
		...
		// no acts lol OBJECT(E_MODEL_NONE, 17975,7455,3280, 0, 0, 0, 0, id_bhvGoombaTripletSpawner),
		...
		// no acts lol OBJECT(E_MODEL_ENEMY_LAKITU, 26000,4592,9542, 0, 0, 0, 0, id_bhvEnemyLakitu),
		// no acts lol OBJECT(E_MODEL_ENEMY_LAKITU, 26000,4592,9542, 0, 0, 0, 0, id_bhvEnemyLakitu),
	...
	AREA(3, bob_area_3),
	    WARP_NODE(10, 9, 3, 0, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF0, 16, 1, 108, WARP_NO_CHECKPOINT),
		WARP_NODE(0xF1, 16, 1, 109, WARP_NO_CHECKPOINT),
