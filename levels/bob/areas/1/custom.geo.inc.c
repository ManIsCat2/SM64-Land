...
const GeoLayout Geo_bob_1_0x1351a50[]= {
...
GEO_ZBUFFER(1),
GEO_OPEN_NODE(),
GEO_CAMERA_FRUSTUM_WITH_FUNC(45,100,46000, geo_camera_fov),
GEO_OPEN_NODE(),
GEO_CAMERA(14,0,2000,6000,3072,0,60928, geo_camera_main),
GEO_OPEN_NODE(),
GEO_DISPLAY_LIST(1,DL_bob_1_0xe05b330),
GEO_DISPLAY_LIST(6,DL_bob_1_0xe0678e0),
GEO_RENDER_OBJ(),
